...
import type { CodexRolloutPreviewCandidate } from "@/server/services/capture-import-service";

interface CodexRolloutImportPreviewProps {
  sessionId: string;
...
export function CodexRolloutImportPreview({
  sessionId,
  sessionStartedAt,
  cwd,
  sourcePath,
  candidates,
}: CodexRolloutImportPreviewProps) {
