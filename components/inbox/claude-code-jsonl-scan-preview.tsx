...
interface ClaudeCodeJsonlScanPreviewProps {
...
export function ClaudeCodeJsonlScanPreview({
  directoryPath,
  summary,
  files,
}: ClaudeCodeJsonlScanPreviewProps) {
  return (
        ...
        {files.map((file) => (
          <Card key={file.filePath}>
            ...
            <CardContent className="space-y-3">
              ...
              <Link
                href={`/inbox/import/claude-code?path=${encodeURIComponent(file.filePath)}`}
