...
import { addAssetToCollectionAction } from "@/app/collections/actions";
...
export function AddAssetDialog({ collectionId, assets, open, onOpenChange }: AddAssetDialogProps) {
  ...
  async function handleAdd() {
    ...
    setIsAdding(true);
    await addAssetToCollectionAction(collectionId, selectedId);
    setIsAdding(false);
    setSelectedId(null);
    onOpenChange(false);
    router.refresh();
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>添加资产到集合</AlertDialogTitle>
          <AlertDialogDescription>
            选择要添加的资产
          </AlertDialogDescription>
        </AlertDialogHeader>
