...
当前正在推进 v0.4：备份、恢复和数据完整性。现已支持完整备份 bundle 导出、迁移/完整性诊断和最近备份时间记录；恢复预览和冲突处理仍在后续迭代中。
...
备份、恢复和数据完整性：已完成完整备份 bundle 导出和更强诊断；恢复预览、冲突策略、checksum 恢复校验和 fresh database 恢复烟测仍待完成。
